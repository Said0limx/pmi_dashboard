...
const ExecutorDelete = ({ executorId, onSuccess }) => {
      ...
      >
        ...
        <div className='flex justify-end gap-2 mt-5'>
          ...
          <Button
            onClick={() =>
              mutate(
                { url: `/admin/strategy-executor/${executorId}/delete`, method: 'DELETE' },
                {
                  onSuccess: () => {
                    close();
                    onSuccess?.();
                    toast.success(t('Executor deleted'));
                  },
                  onError,
                },
              )
