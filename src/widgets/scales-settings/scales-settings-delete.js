...
const ScalesSettingsDelete = ({ id, onSuccess }) => {
      ...
      >
        ...
        <div className='flex justify-end gap-2 mt-5'>
          ...
          <Button
            onClick={() =>
              mutate(
                { url: `/admin/scales-setting/delete/${id}`, method: 'DELETE' },
                {
                  onSuccess: () => {
                    close();
                    onSuccess?.();
                    toast.success(t('Scales setting deleted'));
                  },
                  onError,
                },
              )
...
export default ScalesSettingsDelete;
